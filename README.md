...
7. Create a conection to **_your_** repository by entering this command (remove single quotes): 'git remote set-url origin <yourSshUrlKey> SHgit@github.com:<yourGitHubUserName>'
